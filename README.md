...
### Configuração
  Clone o repositório
  ```
    git clone https://github.com/mindsy/mindsy-microservice-evaluation
  ```
  Inicialize a MindsY
  ```
...
Para verficiar o funcionamento acesse <a href="http://localhost:4000">http://localhost:3003</a>
